...
- **Non-master branches**, prefixed with a short name moniker (e.g. `my-new-feature`) must be used for ongoing work.
- **All modifications** must be made in a **pull-request** to solicit feedback from other contributors.
- A pull-request _must not be merged until all review comments_ are addressed and CI has finished successfully.
